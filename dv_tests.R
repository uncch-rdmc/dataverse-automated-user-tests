...
r10_mainpath_edit_dataset <- function() {
  ...
  print("BEFORE TEST")
  test_dataset_metadata(add_string='edit', is_update=FALSE) 
  print("AFTER TEST")
  sesh$findElement(value='//*[@id="datasetForm:cancelTop"]')$clickElement() #click add data
}
...
test_dataset_metadata <- function(add_string='', is_update=FALSE) {
  ...
  if (is_update) {
    expect_identical(toString(sesh$findElement(value=ds_edit_xpaths['subtitle'])$getElementAttribute("value")), paste(ds_props['subtitle'], add_string, sep=''))
    expect_identical(toString(sesh$findElement(value=ds_edit_xpaths['alternative_title'])$getElementAttribute("value")), paste(ds_props['alternative_title'], add_string, sep=''))
    ...
    expect_identical(toString(sesh$findElement(value=ds_edit_xpaths['other_id_agency'])$getElementAttribute("value")), paste(ds_props['other_id_agency'], add_string, sep=''))
    expect_identical(toString(sesh$findElement(value=ds_edit_xpaths['other_id_id'])$getElementAttribute("value")), paste(ds_props['other_id_id'], add_string, sep=''))
    expect_identical(toString(sesh$findElement(value=ds_edit_xpaths['topic_class_term'])$getElementAttribute("value")), paste(ds_props['topic_class_term'], add_string, sep=''))
    expect_identical(toString(sesh$findElement(value=ds_edit_xpaths['topic_class_cv_name'])$getElementAttribute("value")), paste(ds_props['topic_class_cv_name'], add_string, sep=''))
    expect_identical(toString(sesh$findElement(value=ds_edit_xpaths['language'])$getElementAttribute("value")), paste(ds_props['language'], add_string, sep=''))
    expect_identical(toString(sesh$findElement(value=ds_edit_xpaths['producer_name'])$getElementAttribute("value")), paste(ds_props['producer_name'], add_string, sep=''))
    expect_identical(toString(sesh$findElement(value=ds_edit_xpaths['producer_affiliation'])$getElementAttribute("value")), paste(ds_props['producer_affiliation'], add_string, sep=''))
    expect_identical(toString(sesh$findElement(value=ds_edit_xpaths['producer_abbrev_name'])$getElementAttribute("value")), paste(ds_props['producer_abbrev_name'], add_string, sep=''))
    ...
    expect_identical(toString(sesh$findElement(value=ds_edit_xpaths['producer_date'])$getElementAttribute("value")), paste(ds_props['producer_date'], add_string, sep=''))
    expect_identical(toString(sesh$findElement(value=ds_edit_xpaths['producer_location'])$getElementAttribute("value")), paste(ds_props['producer_location'], add_string, sep=''))
    expect_identical(toString(sesh$findElement(value=ds_edit_xpaths['contributor_type'])$getElementAttribute("value")), paste(ds_props['contributor_type'], add_string, sep=''))
    expect_identical(toString(sesh$findElement(value=ds_edit_xpaths['contributor_name'])$getElementAttribute("value")), paste(ds_props['contributor_name'], add_string, sep=''))
    expect_identical(toString(sesh$findElement(value=ds_edit_xpaths['funding_info_agency'])$getElementAttribute("value")), paste(ds_props['funding_info_agency'], add_string, sep=''))
    expect_identical(toString(sesh$findElement(value=ds_edit_xpaths['funding_info_id'])$getElementAttribute("value")), paste(ds_props['funding_info_id'], add_string, sep=''))
    expect_identical(toString(sesh$findElement(value=ds_edit_xpaths['distributor_name'])$getElementAttribute("value")), paste(ds_props['distributor_name'], add_string, sep=''))
    expect_identical(toString(sesh$findElement(value=ds_edit_xpaths['distributor_affiliation'])$getElementAttribute("value")), paste(ds_props['distributor_affiliation'], add_string, sep=''))
    expect_identical(toString(sesh$findElement(value=ds_edit_xpaths['distributor_abbrev_name'])$getElementAttribute("value")), paste(ds_props['distributor_abbrev_name'], add_string, sep=''))
    ...
    expect_identical(toString(sesh$findElement(value=ds_edit_xpaths['distribution_date'])$getElementAttribute("value")), paste(ds_props['distribution_date'], add_string, sep=''))
    expect_identical(toString(sesh$findElement(value=ds_edit_xpaths['time_period_start'])$getElementAttribute("value")), paste(ds_props['time_period_start'], add_string, sep=''))
    expect_identical(toString(sesh$findElement(value=ds_edit_xpaths['time_period_end'])$getElementAttribute("value")), paste(ds_props['time_period_end'], add_string, sep=''))
    expect_identical(toString(sesh$findElement(value=ds_edit_xpaths['date_of_collection_start'])$getElementAttribute("value")), paste(ds_props['date_of_collection_start'], add_string, sep=''))
    expect_identical(toString(sesh$findElement(value=ds_edit_xpaths['date_of_collection_end'])$getElementAttribute("value")), paste(ds_props['date_of_collection_end'], add_string, sep=''))
    expect_identical(toString(sesh$findElement(value=ds_edit_xpaths['data_type'])$getElementAttribute("value")), paste(ds_props['data_type'], add_string, sep=''))
    expect_identical(toString(sesh$findElement(value=ds_edit_xpaths['series_name'])$getElementAttribute("value")), paste(ds_props['series_name'], add_string, sep=''))
    expect_identical(toString(sesh$findElement(value=ds_edit_xpaths['series_info'])$getElementAttribute("value")), paste(ds_props['series_info'], add_string, sep=''))
    expect_identical(toString(sesh$findElement(value=ds_edit_xpaths['software_name'])$getElementAttribute("value")), paste(ds_props['software_name'], add_string, sep=''))
    expect_identical(toString(sesh$findElement(value=ds_edit_xpaths['software_version'])$getElementAttribute("value")), paste(ds_props['software_version'], add_string, sep=''))
    expect_identical(toString(sesh$findElement(value=ds_edit_xpaths['related_material'])$getElementAttribute("value")), paste(ds_props['related_material'], add_string, sep=''))
    expect_identical(toString(sesh$findElement(value=ds_edit_xpaths['related_dataset'])$getElementAttribute("value")), paste(ds_props['related_dataset'], add_string, sep=''))
    expect_identical(toString(sesh$findElement(value=ds_edit_xpaths['other_reference'])$getElementAttribute("value")), paste(ds_props['other_reference'], add_string, sep=''))
    expect_identical(toString(sesh$findElement(value=ds_edit_xpaths['data_source'])$getElementAttribute("value")), paste(ds_props['data_source'], add_string, sep=''))
    expect_identical(toString(sesh$findElement(value=ds_edit_xpaths['origin_hist_sources'])$getElementAttribute("value")), paste(ds_props['origin_hist_sources'], add_string, sep=''))
    expect_identical(toString(sesh$findElement(value=ds_edit_xpaths['character_of_sources'])$getElementAttribute("value")), paste(ds_props['character_of_sources'], add_string, sep=''))
    expect_identical(toString(sesh$findElement(value=ds_edit_xpaths['doc_to_sources'])$getElementAttribute("value")), paste(ds_props['doc_to_sources'], add_string, sep=''))
  }
}
